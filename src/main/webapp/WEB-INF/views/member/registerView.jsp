...
<body id="page-top">
	...
	<!-- Contact Section-->
	<section class="page-section" id="contact" style="margin-top: 70px">
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<!-- <c:url value="/registerDo" /> " jstl로 사용 가능 -->  
					<form action="/ex00/registerDo" method="post" id="contactForm"
						id="contactForm" data-sb-form-api-token="API_TOKEN">   <!-- 여기서 서버로 연결한하는 주소 입력 -->
						<!-- Name input-->
						<div class="form-floating mb-3">
							...
							<!-- ID입력 input -->
							<div class="invalid-feedback" data-sb-feedback="id:required">아이디를
								입력해 주세요.</div>
						</div>
						<div class="form-floating mb-3">
